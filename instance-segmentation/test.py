...
def test():
    ...
    image_files = sorted(list(test_images_dir.glob("*.bmp")))
        ...
        for img_path in image_files:
            ...
            if results["segments_info"]:
                ...
                detections = sv.Detections(
                    ...
                    mask=masks,
                    class_id=np.array([seg["label_id"] for seg in results["segments_info"]]),
                    confidence=np.array([seg["score"] for seg in results["segments_info"]]),
                )
