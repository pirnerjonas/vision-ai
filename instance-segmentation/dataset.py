                ...
                for i, contour in enumerate(contours):
                    if hierarchy[i][3] == -1:  # No parent = outer contour
                        ...
                        while child_idx != -1:
                            ...
                            cv2.drawContours(hole_mask, [contours[child_idx]], -1, 255, cv2.FILLED)
        ...
        if self.image_processor:
            ...
            if len(instance_id_to_semantic_id) == 0:
                ...
                return {
                    ...
                    "mask_labels": torch.zeros((0, h_resized, w_resized), dtype=torch.float32),
                ...
                unique_ids = sorted([id for id in instance_id_to_semantic_id.keys()])
